...
<div class="w3l-table-info" style="margin-left: -320px; overflow-x: auto;">
					  <h2>View Feedback </h2>
						...
						<tbody>
						  <?php
                                                  $qr="select  * from feedback order by Id desc";
                                                  ...
                                                  ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $r['Email'];?></td>
                                                         ...
                                                         <td>  <a href="del_feedback.php?id=<?php echo $r['Id'];?>"><input type="button" name="btn" value="delete" onclick="alert('are you sure want to delete??')"> </a></td>
