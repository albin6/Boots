                                                    ...
                                                    <td><?php echo $r['Cardno'];?></td>
                                                         ...
                                                         <td><?php echo $r['Cvv'];?></td>     
                                                            <td><?php echo $r['Expirydate'];?></td>
                                                             ...
                                                             <td><a class="btn btn-danger" href="reject.php?id=<?php echo $r['Id'];?>">Reject</a>
                                                                 <a class="btn btn-success" href="delivery_action.php?id=<?php echo $r['Id'];?>">Delivery</a></td> 
                                                          </form>  
                                                    </tr>
                                                    <?php
