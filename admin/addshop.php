...
<div>
    <form class="form-horizontal" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="station" id="focusedinput" value="" required="">
									</div>
        ...
        <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" class="form-control" name="pin" id="focusedinput" value="" required="">
									</div>
									...
									<div class="col-sm-8">
                                                                            <input type="number" class="form-control" name="phone" onkeypress="if(this.value.length==10) return false;" id="focusedinput" value="" required="">
									</div>
									...
									<div class="col-sm-8">
                                                                            <input type="email" class="form-control" name="email" id="focusedinput" value="" required="">
									</div>
           ...
           <div class="form-group">
									...
									<div class="col-sm-8">
                                                                            <input type="password" class="form-control" maxlength="6" name="password" id="pwd" onchange="return Validp();" value="" required="">
