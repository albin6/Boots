                                                  ...
                                                  ?>
                                                    ...
                                                    <td><?php echo $r['Mobile'];?></td>
                                                      ...
                                                      <td>
                                                        ...
                                                        $qb=  mysqli_query($con, "select *from login where Username='$e1'");
                                                        $r1=  mysqli_fetch_array($qb);
                                                     if($r1['Status']=='Pending')
                                                     {
                                                        ?>
                                                          <a href="approve_status.php?id=<?php echo $r1['Id'];?>" class="btn btn-primary">Approve</a>  
                                                          <a href="approve_reject.php?id=<?php echo $r1['Id'];?>" class="btn btn-success">Reject</a> 
                                                          <?php 
                                                     }
                                                     elseif ($r1['Status']=='Approve') {
                                                     ?>
                                                 <a href="approve_reject.php?id=<?php echo $r1['Id'];?>" class="btn btn-success">Reject</a> 
                                                                   
                                                          <?php
                                                 }
                                                 elseif ($r1['Status']=='Reject') {
                                                     ?>
                                                  <a href="approve_status.php?id=<?php echo $r1['Id'];?>" class="btn btn-primary">Approve</a> 
