...
include '../db.php';
$id=$_GET['id'];
$qr="select  * from damageentry where Id='$id'";
...
<div>
    ...
    if(isset($_POST['sub']))
    {
        ...
        $q=  mysqli_query($con,"update damageentry set Reply='$txtname' where Id='$id'");
  
        echo "<script>alert('Successfully send reply...');window.location.href='damageentry.php';</script>"; 
