					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                                                <div class="menu">
                                                       ...
                                                       <ul id="menu">
                                                           <li id="menu-academico" ><a href="damageentry.php"  style="padding: 9px;"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Damage Entry</span> <div class="clearfix"></div></a></li> 
                                                           <li id="menu-academico" ><a href="complaint.php"  style="padding: 9px;"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Send Complaint</span> <div class="clearfix"></div></a></li> 
